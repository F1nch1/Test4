...
public enum MoveState : byte { IDLE, RUNNING, AIRBORNE, SWIMMING, MOUNTED, MOUNTED_AIRBORNE, MOUNTED_SWIMMING, DEAD, CROUCHING, CRAWLING, CLIMBING }
...
#pragma warning restore CS0109 // member does not hide accessible member
    ...
    public KeyCode mouseFreeLookButton = KeyCode.K; // left button by default
    ...
    void UpdateCamera()
    {
        ...
        if (health.current > 0)
        {
            ...
            if (Input.GetKey(mouseFreeLookButton) &&
                !Utils.IsCursorOverUserInterface() &&
